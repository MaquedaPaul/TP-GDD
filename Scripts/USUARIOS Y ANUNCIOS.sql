...
IF EXISTS (SELECT name FROM sys.all_objects s WHERE name = 'ID_INQUILINO' AND s.type='FN')
DROP FUNCTION AMCGDD.ID_INQUILINO

IF EXISTS (SELECT name FROM sys.all_objects s WHERE name = 'ID_COMPRADOR' AND s.type='FN')
DROP FUNCTION AMCGDD.ID_COMPRADOR

IF EXISTS (SELECT name FROM sys.all_objects s WHERE name = 'ID_PROPIETARIO' AND s.type='FN')
